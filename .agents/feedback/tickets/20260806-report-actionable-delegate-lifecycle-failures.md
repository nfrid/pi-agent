...
- **Implementation dependency:** Historical implementation reused artifact primitives from the former schema-driven result system; the current lifecycle contract is independent of that removed model-facing API
