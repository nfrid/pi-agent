...
- **Merged change:** `2a179b1` (implementation `ba67ed8 feat(delegate): add incremental branch review`); review fixes `e85e2cd` (implementation `e983778 fix(delegate): harden branch review provenance and bounds`), `3fd1bc4` (implementation `0d36622 fix(delegate): merge only unintegrated carried patches`), and `53cc9bc` (implementation `b9923b6 fix(delegate): bound branch detail changed paths`)
