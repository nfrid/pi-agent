...
function fixture({ todoCalls = 1, input = 10, cacheRead = 30 } = {}) {
  return [
    ...
    line({
      type: 'custom',
      customType: 'workflow-autonomy-metrics:v2',
      id: 'm1',
      parentId: 'c1',
      ...
      data: {
        ...
        mode: 'canary',
        delegateCalls: 1,
        delegateInputTokens: 20,
        delegateOutputTokens: 5,
        delegateCostUsd: 0.01,
        blockedCapabilityAttempts: 2,
        policyDenials: { 'outside-scope': 2 },
        observedCapabilityViolations: 1,
        autoApprovedLeases: 3,
        leasedRepositories: 1,
        leasedPaths: 4,
        interactiveApprovals: 0,
        interactiveDenials: 0,
        sandboxShellInspectCalls: 2,
        sandboxShellValidateCalls: 1,
        sandboxShellEditCalls: 1,
        sandboxShellFailures: 1,
        sandboxShellAppliedEdits: 1,
        sandboxShellRejectedEdits: 0,
        sandboxShellChangedPaths: 2,
        patchConflicts: 0,
      },
    }),
    line({
...
describe('parseSessionJsonl', () => {
  it('measures only the active leaf ancestry and request usage', () => {
    ...
    expect(result).toMatchObject({
      ...
      malformedLines: 0,
      autonomyMode: 'canary',
      autonomyDelegateCalls: 1,
      autonomyDelegateInputTokens: 20,
      autonomyBlockedAttempts: 2,
      autonomyPolicyDenials: 2,
      autonomyOutsideScopeDenials: 2,
      autonomyAutoApprovedLeases: 3,
      sandboxShellValidateCalls: 1,
      sandboxShellAppliedEdits: 1,
    });
