...
const TOOL_ACTIONS: Readonly<Record<string, string>> = {
  ...
  delegate_gate: 'Gating delegates',
  edit: 'Editing',
  ...
  background: 'Managing background processes',
  background_start: 'Starting background process',
  background_peek: 'Checking background process',
  background_list: 'Listing background processes',
  background_stop: 'Stopping background process',
  background_watch: 'Watching background output',
  background_unwatch: 'Removing background watches',
